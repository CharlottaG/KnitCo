    ...
    if request.method == 'POST':
        ...
        if request.user.is_authenticated:
            form_data = {
                ...
                'town_or_city': request.POST.get('town_or_city', profile.default_town_or_city),
                'street_address': request.POST.get('street_address', profile.default_street_address),
            }
        else:
            form_data = {
        ...
        order_form = OrderForm(data=form_data)  # Use data=form_data to populate the form
...
def checkout_success(request, order_number):
    ...
    messages.success(request, f'Nice stuff, we will pack it asap! \
        ...
        An email is sent to {order.email}.')
